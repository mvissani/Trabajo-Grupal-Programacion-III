                ...
                {availabilityResult.disponible && (
                  <div className="mt-3">
                    ...
                    >
                      ...
                      {availabilityResult.habitaciones &&
                        availabilityResult.habitaciones.length > 0 && (
                          <div className="mt-2">
                            <p
                              className="mb-1"
                              style={{
                            ...
                            >
                              {availabilityResult.habitaciones.map(
                                (hab, idx) => (
                                  <div
                                    key={hab.Id}
                                    style={{
                                      ...
                                      borderBottom:
                                        idx <
                                        availabilityResult.habitaciones.length -
                                          1
                                          ? "1px solid rgba(255, 255, 255, 0.2)"
                                          : "none",
                                    }}
                                  >
                                    <strong>Habitación #{hab.RoomNo}</strong> -{" "}
                                    {hab.Nombre}
                                    <br />
                                    <small style={{ opacity: 0.9 }}>
                                      Capacidad: {hab.Capacidad} personas |
                                      Tarifa: ${hab.Tarifa}/noche
                                    </small>
                                  </div>
                                )
                              )}
