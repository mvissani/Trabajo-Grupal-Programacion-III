    ...
    >
                  ...
                  {selected ? (
                    ...
                    allRooms.map((room) => (
                      <option key={room.Id} value={room.Id}>
                        ...
                        {room.Capacidad}){!room.Disponible ? " ⚠️" : ""}
                      </option>
                    ))
                  ) : (
          ...
          {selectedRoomInfo && (
            <>
              ...
              <p className="text-muted mb-0">
                Por favor, selecciona otra habitación disponible o cambia tus
                fechas de estadía.
              </p>
            </>
          )}
      ...
      >
        ...
        <Modal.Body className="text-center p-5">
          <div className="mb-4">
            <h3 className="text-danger fw-bold mb-3">
              Modificación de fechas no permitida
            </h3>
          ...
          <p className="text-muted mb-0">
            Si necesitas cambiar las fechas, por favor regresa a la página
            anterior y realiza una nueva búsqueda.
          </p>
        </Modal.Body>
        <Modal.Footer className="justify-content-center">
          <Button
